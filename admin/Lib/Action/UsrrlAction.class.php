...
class UsrrlAction extends Action {
    ...
    private $all=array(
      ...
      //自己的全部+f的显示的东西
  		'para'=>array('usrrlid'=>'ID','f_usrrl_usrid'=>'用户','usrnn'=>'用户真名','f_usrrl_rlid'=>'角色','rlnm'=>'角色名','f_rl_grpid'=>'团队','grpnm'=>'团队名'),//NB
    ...
    //   'odr_dflt'=>array('aanm'=>'ASC'),
      ...
      //hide的fld必须有，他们虽然不显示但是必须选择，这样才能在第一次进入query的时候，隐藏属性可以被调用，特别是id和fid
  		'fld_dflt'=>array('usrrlid','f_usrrl_usrid','usrnn','f_usrrl_rlid','rlnm','f_rl_grpid','grpnm'),//NB
  		'cdt_dflt'=>array(),//NB
